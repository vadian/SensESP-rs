...
const I2C_SCANNER_KNOWN_DEVICES: [I2cDeviceInfo; 220] = [
    ...
    (
        ...
        &[0x57, 0x54, 0x50, 0x56, 0x53, 0x55, 0x52, 0x51],
    ),
    (
        "AT24C64",
    ...
    (
        ...
        &[0x2c, 0x2a, 0x2e, 0x2f, 0x2b, 0x2d, 0x28, 0x29],
    ),
    ...
    (
        "HT16K33",
        "LED Matrix Driver",
        &[0x71, 0x72, 0x77, 0x73, 0x70, 0x76, 0x75, 0x74],
    ),
    (
        "HTS221",
    ...
    (
        ...
        &[0x23, 0x24, 0x26, 0x22, 0x27, 0x21, 0x25, 0x20],
    ),
    ...
    (
        ...
        &[
            0x46, 0x49, 0x47, 0x48, 0x4c, 0x4d, 0x43, 0x4b, 0x44, 0x41, 0x4a, 0x45, 0x42, 0x4f,
            0x4e, 0x40,
        ],
    ),
    (
    ...
    (
        ...
        &[
            0x46, 0x57, 0x11, 0x54, 0x47, 0x16, 0x50, 0x10, 0x13, 0x43, 0x56, 0x5a, 0x53, 0x14,
            0x44, 0x59, 0x17, 0x55, 0x41, 0x45, 0x52, 0x42, 0x58, 0x12, 0x51, 0x15, 0x40,
        ],
    ),
    (
        "LM75b",
        "Digital temperature sensor and thermal watchdog",
        &[0x49, 0x48, 0x4c, 0x4d, 0x4b, 0x4a, 0x4f, 0x4e],
    ),
    ...
    (
        ...
        &[0x6c, 0x6e, 0x6b, 0x6a, 0x68, 0x6f, 0x6d, 0x66, 0x69, 0x67],
    ),
    (
        "MA12070P",
    ...
    (
        "MCP3422",
        "18-Bit, Multi-Channel ΔΣ Analog-to-Digital Converter with I2CTM Interface and On-Board Reference",
        &[0x68],
    ),
    (
        "MCP4532",
    ...
    (
        ...
        &[0x64, 0x60, 0x61, 0x65, 0x63, 0x66, 0x62, 0x67],
    ),
    (
        "MCP4725A2",
        "12-Bit Digital-to-Analog Converter with EEPROM Memory",
    ...
    (
        ...
        &[0x1c, 0x1d, 0x18, 0x1b, 0x1f, 0x1a, 0x19, 0x1e],
    ),
    ...
    (
        ...
        &[
            0x5e, 0x64, 0x6c, 0x60, 0x6e, 0x46, 0x6b, 0x57, 0x49, 0x6a, 0x5c, 0x5b, 0x54, 0x47,
            0x48, 0x4c, 0x50, 0x4d, 0x68, 0x43, 0x61, 0x56, 0x4b, 0x5a, 0x53, 0x65, 0x44, 0x7f,
            0x71, 0x72, 0x78, 0x7a, 0x77, 0x59, 0x55, 0x41, 0x4a, 0x73, 0x63, 0x6f, 0x6d, 0x66,
            0x5d, 0x45, 0x5f, 0x7b, 0x70, 0x69, 0x76, 0x52, 0x42, 0x4f, 0x58, 0x7e, 0x75, 0x74,
            0x4e, 0x79, 0x62, 0x51, 0x67, 0x7d, 0x7c, 0x40,
        ],
    ),
    (
        "PCD3311C",
    ...
    (
        ...
        &[0x38, 0x3c, 0x3b, 0x3e, 0x3f, 0x39, 0x3a, 0x3d],
    ),
    (
        "PCF8575",
    ...
    (
        ...
        &[0x46, 0x47, 0x43, 0x44, 0x41, 0x45, 0x42, 0x40],
    ),
    (
        "TMP007",
